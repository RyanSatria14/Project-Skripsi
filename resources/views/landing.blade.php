...
<body>
    ...
    <section class="kelebihan bg-blue text-white">
        <div class="container p-5">
            <div class="row">
                <div class="col-lg-6">
                    <img class="img-fluid d-none d-lg-block" src="{{asset('img/landing/tipebaju.png')}}" alt="" srcset="">
                </div>
                <div class="col-lg-6">
    ...
    <section class="kelebihan bg-blue text-white">
        <div class="container p-5">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid d-none d-lg-block" src="{{asset('img/landing/pegawai.png')}}" alt="" srcset="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="text-center p-5">
        <h3>@lang('landing.what')</h3>
    </section>

    <section class="bg-blue p-5 text-center">

        <li class="nav-item">
            <a class="btn btn-success" href="{{url('member/harga')}}">List Daftar Harga</a>
        </li>
        <br>
